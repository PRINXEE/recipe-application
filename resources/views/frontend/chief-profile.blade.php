...
<!-- Mirrored from ombe.dexignzone.com/bootstrap/xhtml/profile.html by HTTrack Website Copier/3.x [XR&CO'2017], Mon, 07 Oct 2024 11:57:42 GMT -->
<head>
...
<div class="page-wrapper">
	...
	<header class="header header-fixed">
		<div class="header-content">
			...
			<div class="mid-content">
				<h4 class="title">Chief Profile</h4>
			</div>
	...
	<!-- Header -->
	@php
			$totalRecipe = $user->recipes->count(); // Calculate average rating
		...
		<div class="container pt-0">
			<div class="profile-area">
				<div class="author-bx">
			        ...
			        <div>
			          <strong>0</strong>
			          <p class="text-primary">Follower</p>
			        </div>
			        <div>
			          <strong>0</strong>
			          <p>Following</p>
				...
				<div class="widget_getintuch pb-15">
					<ul>
						<li>
							<div class="icon-bx">
								<svg class="svg-primary" enable-background="new 0 0 507.983 507.983" height="24" viewBox="0 0 507.983 507.983" width="24" xmlns="../../../external.html?link=http://www.w3.org/2000/svg">
							...
							<div class="dz-content">
								...
								<h6 class="title">{{ $user->phone_number }}</h6>
							</div>
						</li>
						<li>
							<div class="icon-bx">
								<svg class="svg-primary" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="../../../external.html?link=http://www.w3.org/2000/svg">
				...
				<!-- Most Ordered -->
				<div class="title-bar">
					<h5 class="title">Reicpes</h5>
				</div>
				<div class="container">
					<div class="row g-3" style="margin-left:-22px">
						<?php foreach ($user->recipes as $recipe): ?>
							@php
									$averageRating = $recipe->reviews->avg('rating'); // Calculate average rating
									$totalReviews = $recipe->reviews->count(); // totalReviews
							@endphp
								...
								<div class="dz-wishlist-bx">
									...
									<div class="dz-info">
										<div class="dz-head">
											...
											<p>Variant : {{ $recipe->recipeCategory->name }}, {{ $recipe->recipeCuisine->name }}</p>
										</div>
										<ul class="dz-meta">
											<li class="price flex-1" style="font-size:15px"><i class="fa fa-star" style="font-size:15px;"></i> {{ number_format($averageRating, 1) }}</li>
											<li class="ml-3">reviews ({{ $totalReviews }})</li>
										</ul>
									</div>
								</div>
							</div>
...
<!-- Mirrored from ombe.dexignzone.com/bootstrap/xhtml/profile.html by HTTrack Website Copier/3.x [XR&CO'2017], Mon, 07 Oct 2024 11:57:45 GMT -->
</html>
