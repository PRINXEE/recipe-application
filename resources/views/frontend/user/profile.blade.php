	...
	<header class="header header-fixed">
		<div class="header-content">
			...
			<div class="right-content d-flex align-items-center gap-4">
				<a href="{{ route('edit-user-profile', $profile->id) }}">
					<svg enable-background="new 0 0 461.75 461.75" height="24" viewBox="0 0 461.75 461.75" width="24" xmlns="../../../external.html?link=http://www.w3.org/2000/svg">
					...
					<ul>
						<li>
							...
							<div class="dz-content">
								...
								<h6 class="title">{{ $profile->phone_number }}</h6>
							</div>
						</li>
						<li>
							<div class="icon-bx">
							...
							<div class="dz-content">
								...
								<h6 class="title">{{ $profile->email }}</h6>
							</div>
						</li>
						<li>
							<div class="icon-bx">
					...
					<div class="swiper-wrapper">
						<div class="swiper-slide">
							<div class="dz-card list style-4">
								<div class="dz-media">
									<img src="{{ asset('frontend-assets/images/order/pic1.png') }}" alt="">
								</div>
								<div class="dz-content">
						...
						<div class="swiper-slide">
							<div class="dz-card list style-4">
								<div class="dz-media">
									<img src="{{ asset('frontend-assets/images/order/pic2.png') }}" alt="">
								</div>
								<div class="dz-content">
