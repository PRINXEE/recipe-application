    ...
    <div id="kt_app_content_container" class="app-container container-fluid">
      ...
      <div class="card mb-5 mb-xl-10">
        ...
        <div class="collapse show">
          <!--begin::Form-->
          <form method="post" class="form" action="{{ route('faq-store') }}">
            @csrf
            <!--begin::Card body-->
            <div class="card-body border-top">
              ...
              <div class="row mb-10">
                ...
                <div class="col-lg-9 fv-row fv-plugins-icon-container">
                  <input type="text" name="question" class="form-control form-control-lg form-control-solid" placeholder="Enter question" required>
                </div>
                <!--end::Col-->
              </div>
              <!--end::Input group-->
              ...
              <div class="row mb-10">
                ...
                <!--begin::Col-->
                <div class="col-lg-9 fv-row fv-plugins-icon-container">
                  <textarea name="answer" class="form-control form-control-solid" data-kt-autosize="true" placeholder="Enter answer" rows="4" required></textarea>
                </div>
                <!--end::Col-->
              </div>
              <!--end::Input group-->
                ...
                <div class="col-lg-9 fv-row fv-plugins-icon-container">
                  <div class="d-flex fv-row">
                    <label class="form-check form-check-custom form-check-sm me-20">
                      <input class="form-check-input"  type="radio" id="Publish" name="status" value="1" {{ old('status') == '1' ? 'checked' : '' }} />
                      <span class="form-check-label fw-semibold fs-5">Publish </span>
                    </label>
                    <label class="form-check form-check-custom form-check-sm">
                      <input class="form-check-input" type="radio" id="UnPublish" name="status" value="0" {{ old('status') == '0' ? 'checked' : '' }} />
