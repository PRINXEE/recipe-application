...
@section('title', 'Admin | Recipe Gallery')
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid pt-0">
      ...
      <div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="row">
          ...
          <?php if ($gallery->gallery_image == null): ?>
            <!-- begin::image -->
            <div class="col-lg-3 col-xxl-3 mb-10">
              <!--begin::Budget-->
              <div class="card border-hover-primary">
                <div class="card-body h-350px p-0">
                  <h4>sorry No Image on this Recipe Gallery</h4>
                </div>
              </div>
              <!--end::Budget-->
            </div>
              ...
              <div class="modal fade" id="kt_modal_edit_gallery_<?= $key ?>" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <!-- begin:: form -->
                    <form action="{{ route('update-gallery-image') }}" method="post" enctype="multipart/form-data" class="m-0">
                      <!-- begin::modal-body -->
              ...
              <div class="modal fade" id="kt_modal_delete_gallery_<?= $key ?>" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <!-- begin::modal-footer -->
                    <div class="modal-footer">
                      <a class="btn btn-danger" href="{{ route('delete-gallery-image', ['id' => $gallery->id, 'name' => $image]) }}">
        ...
        <!-- begin::back button -->
        <a href="{{ route('recipe') }}"> <button type="button" class="btn btn-primary mt-10">Back</button></a>
        <!-- end:back button -->
      </div>
