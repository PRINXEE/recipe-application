...
@section('title', 'Chief | Edit My Recipe')
@section('content')
      ...
      <div class="row g-5 d-flex justify-content-center">
        <div class="card mb-5 mb-xl-10">
          ...
          <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <!--begin::Form-->
            <form action="{{ route('update-my-recipe') }}" class="form" method="post" enctype="multipart/form-data">
              @csrf
              @method('PUT')
              <!--begin::Card body-->
...
<script type="text/javascript">
    ...
    $('.remove-ingredient').on('click', function() {
        ...
        $.ajax({
            url: '/chief/delete-my-ingredient', // Assuming the route to delete ingredient is /ingredients/{id}
            type: 'get',
            data: {
