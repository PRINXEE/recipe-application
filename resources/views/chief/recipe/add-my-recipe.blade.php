...
@section('title', 'Chief | Add Recipe')
@section('content')
      ...
      <div class="row g-5 d-flex justify-content-center">
        <div class="card mb-5 mb-xl-10">
          ...
          <div id="kt_account_settings_profile_details" class="collapse show">
            ...
            <!--begin::Form-->
            <form action="{{ route('my-recipe-store') }}" class="form" method="post" enctype="multipart/form-data">
               @csrf
              <!--begin::Card body-->
              <div class="card-body border-top p-9">
                ...
                <div class="row mb-10">
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-lg form-control-solid " name="recipe_name" placeholder="Enter Recipe Name" required />
                  </div>
                  <div class="col-sm-6">
                    <label class="form-label required">Image</label>
                    <input type="file" name="recipe_image" id="imageInput" class="file-upload-default" accept=".png, .jpg, .jpeg">
                    <div class="input-group col-xs-12">
                      <input type="text" class="form-control form-control-lg form-control-solid  file-upload-info" placeholder="Choose Image" required>
                              ...
                              <div data-repeater-item>
                                <div class="form-group row px-5">
                                  <div class="col-md-6 mb-8">
                                    <input type="text" name="ingredients" class="form-control form-control-lg form-control-solid" placeholder="Enter an ingredient name, e.g., 1 teaspoon salt" required />
                                  </div>
                ...
                <div class="row mb-10">
                  <div class="col-sm-6">
                    ...
                    <select name="category_id" class="form-select form-select-solid" data-control="select2" data-placeholder="Select a category" required>
                      <option></option>

                      <?php foreach ($recipes as $cat): ?>
                  ...
                  <div class="col-sm-6">
                    ...
                    <select name="cuisine_id" class="form-select form-select-solid" data-control="select2" data-placeholder="Select a cuisines" required>
                      <option></option>
                ...
                <div class="row mb-10">
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-lg form-control-solid" name="prep_time" placeholder="Enter prep Time" required />
                  </div>
                  <div class="col-sm-6">
                    <label class="form-label required">CookingTime</label>
                    <input type="text" class="form-control form-control-lg form-control-solid" name="cooking_time" placeholder="Enter Cook Time" required />
                  </div>
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-10">
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-lg form-control-solid" name="serving_size" placeholder="Enter Number of Servings" required />
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="row mb-10">
                  <div class="col-sm-6">
                    ...
                    <select name="difficulty_level" class="form-select form-select-solid" data-control="select2" data-placeholder="Select a Difficulty Level" required>
                      <option></option>
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control form-control-lg form-control-solid" name="recipe_youtube_video_url" placeholder="Enter YouTube Link" />
                  </div>
                </div>
                <!--end::Input group-->
                ...
                <div class="row mb-10">
                  ...
                  <div class="col-sm-6">
                    ...
                    <input type="file" name="gallery_image[]" id="imageInput" class="file-upload-default" accept=".png, .jpg, .jpeg" multiple>
                ...
                <div class="row mb-10">
                  <div class="col-sm-12">
                    ...
                    <textarea name="description" id="kt_docs_first_ckeditor_classic" placeholder="Enter a brief overview of the recipe, including key ingredients and cooking style"></textarea>
                  </div>
                </div>
                <!--end::Input group-->
                ...
                <div class="fv-row mb-2">
                  <div class="col-sm-12">
                    ...
                    <textarea class="form-control form-control-lg" id="kt_docs_second_ckeditor_classic" name="instruction" placeholder="Describe the cooking process" style="height: 300px;"></textarea>
                  </div>
                </div>
                <!--end::Input group-->
...
$(document).ready(function() {
    ...
    const tagContainer = $('#tag-container'); // Container for displaying tags
    const tagInput = $('#tag-input'); // The text input for new tags
    const hiddenTagInput = $('#tags-hidden'); // Hidden input for storing tags to be submitted
