...
@section('title', 'Chief | My Recipes')
@section('content')
        ...
        <div class="card-header border-0 pt-6">
          ...
          <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
              <!--begin::Add recipe -->
              <a href="{{ route('add-my-recipe') }}" class="btn btn-primary">
                ...
                <tr>
                  ...
                  <td class="pe-0">
                    <div class="d-flex align-items-center">
                      <!-- view -->
                      <a href="{{ route('my-recipe-gallery', $recipe->id) }}">
                      ...
                      <!-- edit -->
                      <a href="{{ route('edit-my-recipe', $recipe->id) }}" class="menu-link">
                        <div class="symbol symbol-40px symbol-circle user-select-none">
                  ...
                  <div class="modal-dialog ">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <a href="{{ route('delete-my-recipe', ['id' => $recipe->id]) }}" class="btn btn-danger btn-lg">Delete</a>
                      </div>
                      </form>
                    </div>
                  </div>
