...
<!-- Mirrored from ombe.dexignzone.com/bootstrap/xhtml/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2017], Mon, 07 Oct 2024 11:58:55 GMT -->
<head>
...
<div class="page-wrapper">
    ...
    @endif
		...
		<div class="container py-0">
          ...
          <form class="m-b30" method="POST" action="{{ route('password.email') }}">
              @csrf
						<div class="mb-4">
            ...
            <div class="bottom-btn pb-3">
        			<button type="submit" class="btn btn-thin btn-lg w-100 btn-primary rounded-xl">Send Mail</button>
        			<div class="text-center mt-3 form-text">Back To <a href="#" class="text-underline link">Sign In</a></div>
        		</div>
					</form>
				</div>
			</div>
    		...
    		<!-- <div class="bottom-btn pb-3">
    			<a href="otp-confirm.html" class="btn btn-thin btn-lg w-100 btn-primary rounded-xl">Send Mail</a>
